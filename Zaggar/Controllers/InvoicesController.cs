...
namespace Zaggar.Controllers
{
    public class InvoicesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "InvoiceID,InvoiceDate,CustomerID")] Invoice invoice)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "InvoiceID,InvoiceDate,CustomerID")] Invoice invoice)
        {
            if (ModelState.IsValid)
            {
